...
This is a browser-based seasonal action RPG with idle progression and auto-battle combat. Players configure their build first, then characters auto-clear maps, while boss fights allow limited manual intervention. Offline progression continues to generate resources and support long-term growth. [ericguan.substack](https://ericguan.substack.com/p/idle-game-design-principles)

## 2. Design Goals

The game is designed around four pillars:

1. **Fast reward loop.** Players should gain noticeable progress within minutes.
2. **Automated map progression.** Most regular combat should be hands-off once the build is configured.
3. **Seasonal replay value.** Every 14-day season resets progression and introduces a new mechanical twist.
4. **Clear build diversity.** Different classes and archetypes must feel meaningfully different.

This structure follows common GDD best practices: define the core loop, document systems and constraints, and keep the player fantasy consistent across all major features. [indiegameacademy](https://indiegameacademy.com/free-game-design-document-template-how-to-guide/)
...
3. Upgrade character, skills, and equipment.
4. Configure skill priority, target priority, and defensive triggers.
5. Auto-farm maps.
6. Fight elites and bosses.
7. Claim drops and rewards.
8. Log out and continue offline progression.

### 4.2 Short Loop
Clear a stage → get loot → swap gear → upgrade skills → challenge harder content.

### 4.3 Loop Intent
The loop should reward both **active optimization** and **passive accumulation**. Players should feel that their preparation affects battle outcomes more than moment-to-moment manual skill. [gitbook](https://www.gitbook.com/blog/how-to-write-a-game-design-document)
...
1. Check whether a skill is off cooldown.
2. Check whether resource cost can be paid.
3. Check whether target conditions are valid.
4. Check whether HP or boss-phase thresholds are met.
5. Resolve the highest-priority eligible action.

This keeps the system readable and easier to balance for auto-battle play. [davidmullich](https://davidmullich.com/2018/06/25/an-actionable-game-design-document-template/)
...
This creates multiple return intervals, which is a common retention principle in idle design. [gridinc.co](https://gridinc.co.za/blog/idle-games-best-practices)
...
Progression should alternate between small gains and major breakthrough moments. This helps avoid stagnation and supports the “one more run” feeling common in progression-driven games. [ericguan.substack](https://ericguan.substack.com/p/idle-game-design-principles)
